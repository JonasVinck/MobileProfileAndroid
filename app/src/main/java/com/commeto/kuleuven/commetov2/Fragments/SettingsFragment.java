...
//==================================================================================================
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        final SharedPreferences preferences = activity.getSharedPreferences("commeto", MODE_PRIVATE);
...
//==================================================================================================
    ...
    private void resetSettings(){
        ...
        SharedPreferences preferences = activity.getSharedPreferences("commeto", MODE_PRIVATE);
        ((TextView) activity.findViewById(R.id.ip)).setText(preferences.getString("baseUrl", "no ip available"));
        ((TextView) activity.findViewById(R.id.socket)).setText(preferences.getString("socket", "443"));
    ...
    private void resetDebug(){
        ...
        if(!preferences.getBoolean("debug", false)){
            preferences.edit()
                    ...
                    .putString("baseUrl", "213.118.13.252")
                    .apply();
        }
    }
//==================================================================================================
